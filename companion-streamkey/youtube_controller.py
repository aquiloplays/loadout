...
back to the dock (which auto-copies the key to the clipboard for pasting
into the user's encoder), and tears down cleanly on End.

Lives alongside (not inside) the TikTok `Controller` so the slobs
