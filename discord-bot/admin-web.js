...
// (Bolts economy sunset 2026-06: the Boltbound expansion-release admin
// route + its imports (boltbound-release.js, cards-web.js,
// boltbound-sets.js) were removed — Boltbound is dormant.)
...
export async function handleAdminWeb(env, route, guildId, body) {
  ...
  // (Bolts economy sunset: the Boltbound expansion-release toggle route
  // /web/admin/expansion/<slug>/(release|hide) was removed.)
  switch (route) {
