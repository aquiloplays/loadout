...
const TEMPLATES = [
  {
    id: 'play-pvp-week',
    name: 'Game Night',
    description: 'The community plays {target} PvP card matches this week.',
  ...
  },
  {
    id: 'win-raids-week',
    name: 'Goblin Hunt',
    description: 'The community wins {target} Clash raids this week.',
    kinds: ['clash.raid.won.1', 'clash.raid.won.2', 'clash.raid.won.3'],
    units: () => 1,
    target: 300,
    reward: { bolts: 1500, top: 5 },
    icon: '⚔️',
  },
  {
    id: 'levelup-week',
    name: 'Hero Surge',
    description: 'The community gains {target} hero levels this week.',
    kinds: ['hero.levelup'],
    units: (e) => Math.max(1, Number(e.meta?.newLevel) || 1),
    target: 800,
    reward: { bolts: 1500, top: 5 },
    icon: '⚡',
  },
  {
    id: 'donate-bolts-week',
    name: 'War Chest',
    description: 'The community donates {target} bolts to their guild treasuries this week.',
    kinds: ['clash.donated'],
    units: (e) => Math.max(0, Number(e.meta?.bolts) || 0),
    target: 50000,
    reward: { bolts: 2000, top: 5 },
    icon: '💰',
  },
  {
    id: 'bet-wins-week',
