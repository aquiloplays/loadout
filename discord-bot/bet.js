...
// stays dormant while sports betting works fully. Restore hub-menu.js and
// re-point these imports if the notifier is ever wanted back.
async function seedTeamRegistry() { /* no-op: team-registry feed retired */ }
async function noteTeamsFromGames() { /* no-op: team-registry feed retired */ }
async function findSubscribersForGame() { return []; }
