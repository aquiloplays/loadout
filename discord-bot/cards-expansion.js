...
const FAMILIES = [
  ...
  // are 'Relic' — see cards-content.js + CARD-GAME-DESIGN.md.)
  {
    ...
    minionNames: {
      common: [
        'Apprentice Hunter','Relic Mote','Treasure Sprite','Key Sprite',
        'Relic Imp','Treasure Knight','Key Knight','Relic Sprite','Treasure-Pup','Relic Pup',
        'Relic Knight','Treasure Magister','Key Magister','Relic-Marten','Treasure-Marten','Relic Marten',
        'Relic Magister','Treasure Sovereign','Key Sovereign','Relic Sovereign','Treasure Patriarch','Relic Patriarch',
        'Relic Tyrant','Treasure Tyrant','Key Tyrant','Relic Patriarch','Treasure Patriarch',
        'Relic Throne','Treasure Throne','Key Throne','Relic Sovereign-Lord',
        'Relic Patriarch','Treasure Patriarch-Lord','Key Patriarch',
        'Relic Colossus','Treasure Colossus',
      ],
      uncommon: [
        'Relic Imp','Treasure Sprite',
        'Relic Sprite','Key Sprite','Treasure Pup',
        'Relic Knight','Treasure Magister','Key Magister','Relic-Marten',
        'Relic Magister','Treasure Sovereign','Key Sovereign',
        'Relic Tyrant','Treasure Tyrant','Key Tyrant',
        'Relic Patriarch','Treasure Patriarch',
        'Relic Crown',
      ],
      rare: [
        'Relic Patriarch','Treasure Patriarch',
        'Key Sovereign','Relic Sovereign-Lord',
        'Relic Magister-Lord','Treasure Magister-Lord',
        'Relic Throne',
        'Treasure Throne',
      ],
      legendary: ['Calderon, Relic-Crowned', 'Aurellis the Key-Sovereign'],
    },
    spellNames: {
      common: ['Pry','Dig','Mark','Relic Touch','Treasure Touch','Key Touch','Relic Mark'],
      uncommon: ['Relic Pulse','Treasure Surge','Key Cascade','Relic Brand'],
      rare: ['Relic Storm','Treasure Strike'],
    },
    minionTemplates: 'basic',
    splitBias: -1,
    drawHeavy: true,
