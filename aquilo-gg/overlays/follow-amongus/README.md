...
An **Among Us** TikTok follow overlay. A dark spaceship-HUD bar —
*Follow = Random Game Effect* — sits bottom-centre with a crewmate-red trim,
...
a random-colour crewmate bounces up and hovers, an *EMERGENCY MEETING* red flash
