...
A **Fallout 4 / Pip-Boy** TikTok follow overlay. A terminal-green bar, *Follow = Random Game Effect*, sits bottom-centre with a CRT-flicker glow and
...
`popIn 500 · idle 400 · charge 750 · boom 200 · smoke 850 · fade 300` ms, Vault Boy bounces up with a thumbs-up, the Pip-Boy screen flickers with
