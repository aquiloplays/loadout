...
- The pet does NOT appear in raid replays or town views (Clash) —
  keeps PvP imagery uncluttered. Renderer flag: `?nopet=1` for
  raid contexts.
...
Clay-decisions list. Sensible defaults assumed during the build —
flag for sign-off after first viewing:
